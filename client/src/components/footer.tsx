    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            <h5 className="font-semibold mb-4">Legal Resources</h5>
            <ul className="space-y-2 text-sm text-gray-400">
              <li><Link href="/resources" className="hover:text-white transition-colors">UCMJ Articles</Link></li>
              <li><Link href="/resources" className="hover:text-white transition-colors">Court-Martial Guide</Link></li>
              <li><Link href="/resources" className="hover:text-white transition-colors">Administrative Actions</Link></li>
              <li><Link href="/resources" className="hover:text-white transition-colors">Security Clearance</Link></li>
              <li><Link href="/resources" className="hover:text-white transition-colors">Appeals Process</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link href="/legal-disclaimers" className="hover:text-white transition-colors">Legal Disclaimers</Link></li>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-4 md:mt-0">
              <p className="text-xs text-gray-500 flex items-center">
                ...
                This platform provides legal information only. Not a substitute for professional legal advice.
              </p>
            </div>
          </div>
        </div>
